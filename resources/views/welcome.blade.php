...
<body
    ...
    <header id="main-header"
        class="fixed top-0 left-0 right-0 z-50 flex justify-center transition-transform duration-300 bg-[#FDFDFC]/80 dark:bg-[#0a0a0a]/80 backdrop-blur-lg border-b border-[#19140010] dark:border-[#ffffff10]">
        <div class="w-full lg:max-w-4xl max-w-[335px] py-4 text-sm not-has-[nav]:hidden">
            @if (Route::has('login'))
