...
@section('content')
    ...
    <div class="page-header">
        <a href="{{ route('reception.patients') }}" class="btn-back">
            ← Back to Patients
        </a>
    </div>
    ...
    <div class="info-card">
        ...
        <div class="info-row"><b>Blood Group:</b> {{ $patient->blood_group ?? 'N/A' }}</div>
        <div class="info-row"><b>Mobile:</b> {{ $patient->mobile ?? 'N/A' }}</div>
        <div class="info-row"><b>Address:</b> {{ $patient->address ?? 'N/A' }}</div>
        <div class="info-row"><b>Emergency Contact:</b> {{ $patient->emergency_contact ?? 'N/A' }}</div>
    </div>
    ...
    <div class="card">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="4" style="text-align: center; padding: 20px; color: #64748b;">No appointments found</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
